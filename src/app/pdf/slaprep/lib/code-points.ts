...
export const isUnassignedCodePoint = (character: number) =>
...
export const isCommonlyMappedToNothing = (character: number) =>
...
export const isBidirectionalRAL = (character: number) =>
...
export const isBidirectionalL = (character: any) =>
  inRange(character, bidirectional_l);
