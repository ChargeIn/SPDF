...
import { ExpertEncoding, StandardEncoding } from './CFFEncodings';
import {
  ExpertCharset,
  ExpertSubsetCharset,
  ISOAdobeCharset,
...
class PredefinedOp {
  private readonly predefinedOps: string[][];
  private type: CFFPointer;

  constructor(predefinedOps: string[][], type: CFFPointer) {
